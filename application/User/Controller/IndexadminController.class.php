...
class IndexadminController extends AdminbaseController {
    ...
    public function ban(){
    	...
    	if ($id) {
    		$result = $this->members_model->where(array("id"=>$id,"user_type"=>2))->setField('user_status',0);
    		if ($result) {
    ...
    public function cancelban(){
    	$id= I('get.id',0,'intval');
    	if ($id) {
    		$result = $this->members_model->where(array("id"=>$id,"user_type"=>2))->setField('user_status',1);
    		if ($result) {
